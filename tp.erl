-module (tp).
-export ([voyage / 2, livreLePlusCher / 0, livreLeMoinsCher / 0, livreAuteur / 1]).
...
createList() -> [
	...
	#livre{isbn = 2221088913, titre = "Maison Atréides", auteur1 = "Brian Herbert",
	...
	#livre{isbn = 2290088404, titre = "De bons présages", auteur1 = "Terry Pratchett",
...
livreAuteur(Auteur) -> lists:keysearch(Auteur, #livre.auteur1, createList()).